...
/*sauces*/
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Tomato sauce","sauce","This is a regular souce where we add all the necessary ingridients what is needed to a good pizza sauce",0.55,load_file("C:/Pictures/Sauces/tomato.jpg"));
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Mustard","sauce","It's stone-ground for a traditional tangy flavor. Ingredients: Distilled White Vinegar, Mustard Seed, Water, Salt, Turmeric, Natural Flavor and Spices. ",0.7,load_file("C:/Pictures/Sauces/mustard.jpg"));
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Spicy sauce","sauce","Add some spice to your life with Cholula Hot Sauce Original. This authentic hot sauce is imported straight from Mexico. It adds a fiery taste to your meals whenever you need an extra kick of spice. ",1.00,load_file("C:/Pictures/Sauces/spicy.jpg"));
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Sour cream","sauce","It could be the fresh and delicious taste, the rich and creamy texture, or that it’s made from simple, wholesome ingredients - with no artificial additives or preservatives.",0.45,load_file("C:/Pictures/Sauces/sour.jpg"));
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Nutella","sauce","SpreadMade with skim milk and cocoaOver 100 hazelnuts per jarContains no artificial colors or preservatives Nutella Hazelnut Spread",1.25,load_file("C:/Pictures/Sauces/nutella.jpg"));
...
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Pepper","topping","Freshly sliced pepper is always a perfect choice",0.3,load_file("C:/Pictures/Toppings/pepper.jpg"));
...
insert into pizzamaker.foods(name,type,description,price,rawpicture) values("Bean","topping","Caned bean",0.3,load_file("C:/Pictures/Toppings/bean.jpg"));
